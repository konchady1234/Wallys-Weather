...
<div style="float:left"><?=get_symbol($faq['web_title'])?></div><div><a href="javascript:toggleDiv('myContent_<?=$i?>');" style=" float:right;"><img src="image/showhide.png" width="16" height="16" style="    vertical-align: bottom;" /></a></div>
<div class="clear"></div>
<div id="myContent_<?=$i?>" style="padding: 5px 10px; display: block; background-color: rgb(170, 170, 170);">
